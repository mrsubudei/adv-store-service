...
func TestCreate(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		if err := service.Create(ctx, advert1); err != nil {
			t.Fatal(err)
		}
	})
...
func TestGetById(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		if found, err := service.GetById(ctx, 1); err != nil {
		    t.Fatal(err)
...
func TestGetAll(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		if err := service.Create(ctx, advert2); err != nil {
			t.Fatal(err)
		}
		
		if err := service.Create(ctx, advert3); err != nil {
			t.Fatal(err)
		}
...
func TestUpdate(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		if found, err := service.GetById(ctx, 1); err != nil {
		    t.Fatal(err)
		} else if !reflect.DeepEqual(updated, found) {
...
func TestDelete(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		if _, err := service.GetById(ctx, 1); err == nil {
		    t.Fatal("Error expected")
		} else if !errors.Is(err, entity.ErrItemNotExists) {
            t.Fatalf("want: %v, got: %v", entity.ErrItemNotExists, err)
        }
